...
// you can load an URL
        this.setTitle("RKV ABC CHANNEL");
        webView.loadUrl("https://abc.abhiyanth.org/");
    }
                    ...
                    .addOnCompleteListener(new OnCompleteListener<Void>() {
                        ...
                        public void onComplete(@NonNull Task<Void> task) {
                            if (task.isSuccessful()) {
                                Toast.makeText(abc.this, "Verification link was send to your mail", Toast.LENGTH_SHORT).show();
                            }
                        }
                    });
        }
